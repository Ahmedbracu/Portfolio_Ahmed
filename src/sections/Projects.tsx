            ...
            {filteredProjects.map((project, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="group relative overflow-hidden rounded-2xl border border-dark-200 bg-dark-100 transition-all duration-300 hover:border-brand-indigo/50 hover:shadow-glow-sm"
                >
                  {/* Admin Actions */}
                  {isAdmin && (
                    <div className="absolute right-3 top-3 z-20 flex gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-lg bg-dark-200 text-white transition-colors hover:bg-brand-indigo"
                      >
                        <Pencil className="h-4 w-4" />
                      </button>
                      <button
                        onClick={() => setDeleteConfirmId(project.id)}
                        className="flex h-8 w-8 items-center justify-center rounded-lg bg-dark-200 text-white transition-colors hover:bg-red-500"
                      >
                  ...
                  <div className="p-5">
                    ...
                    {project.link && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-sm text-brand-indigo transition-colors hover:text-brand-violet"
                      >
                        View Project
